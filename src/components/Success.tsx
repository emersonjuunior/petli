...
const Success = ({ msg }: Props) => {
  return (
    <div className="fixed bottom-10 left-5 md:left-16 w-[304px] md:w-[380px] h-[70px] flex items-center bg-[#edfbd8] border border-[#84d65a] rounded px-2 py-2 font-light shadow-[4px_4px_10px_-10px_rgba(0,0,0,1)] transform animate-notification animate-delay-[3s] z-50">
